...
export DATA_DIR="<path-to-processed-training-data>"
export TRAIN_DATA_DIR=$DATA_DIR
export TEST_DATA_DIR=$DATA_DIR

export BASE_MODEL="<path-to-base-model>"
export EXPERIMENT_NAME=nq-search-r1-grpo-improve-nqhot-qwen2.5-3b-em
export LLD_COEF=0.2
...
mkdir -p /tmp/xdg_config /tmp/xdg_cache
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.val_data_num=1300 \
    data.train_batch_size=128 \
    data.val_batch_size=64 \
    data.max_prompt_length=16284 \
