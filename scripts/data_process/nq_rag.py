...
if __name__ == '__main__':
    ...
    parser.add_argument('--corpus_path', type=str, default='<path-to-wikipedia-corpus-jsonl>')
    parser.add_argument('--train_retrieval_cache', type=str, default='<path-to-train-retrieval-cache-json>')
    parser.add_argument('--test_retrieval_cache', type=str, default='<path-to-test-retrieval-cache-json>')
